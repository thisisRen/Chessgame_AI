...
public class ChessAI : MonoBehaviour
{
    ...
    private void Move(Chessman chessman, int x, int y, int depth)
    {
        ...
        if (chessman.GetType() == typeof(King) && System.Math.Abs(x - chessman.currentX) == 2 && y-1 == chessman.currentY)
        {
            Debug.Log("x: " + x + "   " + chessman.currentX);
            Debug.Log("y: " + y + "   " + chessman.currentY);
        ...
        SoundManager.Instance.PlayEffect("clickB");
